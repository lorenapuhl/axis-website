        ...
        <div className="flex flex-col items-center text-center gap-10 md:gap-14">
          ...
          */}
          <motion.h2
            ...
            viewport={{ once: true }}
            className="flex flex-col items-center gap-3 font-playfair text-xl md:text-4xl text-soft-grey tracking-tight leading-tight"
          >
          ...
          */}
          <div className=" flex flex-row flex-wrap gap-x-4 md:gap-x-6 gap-y-2 items-baseline justify-center">
            ...
            {/* WORD 1 */}
            <motion.span
              className="font-playfair text-xl md:text-4xl text-soft-grey tracking-wide"
          ...
          */}
          <motion.p
            ...
            viewport={{ once: true }}
            className="font-playfair font-thin text-xl md:text-4xl tracking-tight text-white-axis leading-tight"
          >
            But they don't book.
          </motion.p>
